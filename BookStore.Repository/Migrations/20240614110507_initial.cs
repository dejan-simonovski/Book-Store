    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPublisherInCart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookPublisherInCart_BookPublisher_BookPublisherId",
                        column: x => x.BookPublisherId,
                        principalTable: "BookPublisher",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPublisherInCart_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPublisherInOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookPublisherInOrder_BookPublisher_OrderedBookId",
                        column: x => x.OrderedBookId,
                        principalTable: "BookPublisher",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPublisherInOrder_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPublisherInCart_BookPublisherId",
                table: "BookPublisherInCart",
                column: "BookPublisherId");

            migrationBuilder.CreateIndex(
                name: "IX_BookPublisherInCart_ShoppingCartId",
                table: "BookPublisherInCart",
                column: "ShoppingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_BookPublisherInOrder_OrderedBookId",
                table: "BookPublisherInOrder",
                column: "OrderedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookPublisherInOrder_OrderId",
                table: "BookPublisherInOrder",
                column: "OrderId");
